#Nombre: Tomalá Gonzalez César Steven
...
class Operaciones:
    ...
    def operaciones(self):
        numero1 = int(input("ingrese el primer n1: "))
        numero2= int(input("Ingrese el segundo n2: "))
        a =  numero1 + numero2 
        b =  numero1 - numero2
        c =  numero1 * numero2 
        d =  numero1 / numero2
    ...
    def hipotenusa(self):
        numero1 = int(input("Ingresar un n1: "))
        numero2 = int(input("Ingresar un n2: "))
